...
This setting controls the deployment image. Local build processing, `mda dev`, Harbor task images, and [execution sandboxes](/langsmith/managed-deep-agents-sandboxes) select their interpreters separately.
:::
