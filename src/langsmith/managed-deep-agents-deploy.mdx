...
This controls the deployment image only. Local builds, `mda dev`, Harbor task images, and [execution sandboxes](/langsmith/managed-deep-agents-sandboxes) select their interpreters separately.
:::
