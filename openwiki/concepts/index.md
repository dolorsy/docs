...
- [Language Versioning Strategy](versioning.md) - How source classification, build-time language rendering, emitted routes, and docs.json navigation cooperate for shared OSS documentation, intentional unversioned products, and Managed Deep Agents.
